<div class="d-flex flex-column p-5 deliveries-container">
	<h3 class="mb-5">LIST OF DELIVERIES</h3>
	<div class="d-flex justify-content-between mb-5 search-bar" id="wildcards">
		...
		<div class="d-flex right-panel">
			<select name="sort_status" id="" class="form-select me-1 sort-status sorting select-field" aria-label="Default select example">
				...
				<option value="approved">List of Approved Orders</option>
				<option value="pending">List of Pending Orders</option>
			</select>
			...
			<select name="limit_per_page" id="" class="form-select sort-display sorting select-field" aria-label="Default select example">
